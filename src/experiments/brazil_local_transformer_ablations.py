"""
Brazil — LTGCN ablation experiments.
"""
...
_VALID_VARIANTS = {
    "brazil_ltgcn_temporal_only": "temporal_only",
    "brazil_ltgcn_spatial_only": "spatial_only",
    "brazil_ltgcn_no_fusion": "no_fusion",
    "brazil_linear_temporal_gcn": "linear_temporal_gcn",
}

_BRAZIL_DEFAULT_HIDDEN = {
    "brazil_ltgcn_temporal_only": 72,
    "brazil_ltgcn_spatial_only": 244,
    "brazil_ltgcn_no_fusion": 68,
    "brazil_linear_temporal_gcn": 124,
}
...
def _build_default_cfg(name: str) -> ExperimentConfig:
    return ExperimentConfig(
        ...
        model=ModelConfig(
            ...
            trans_hidden=_BRAZIL_DEFAULT_HIDDEN[name],
            nhead=4,
            graph_feat_dim=1,
        ),
...
def run(cfg: ExperimentConfig = None):
    if cfg is None:
        cfg = _build_default_cfg("brazil_ltgcn_temporal_only")
